...
print "user_login_exists('fat') is ",ha.user_login_exists('fat')
...
ha.assert_resource('ruid0002', 'foo', "/foo/foo", "My favorite Bathtime Gurgles 2", False)
ha.share_resource_with_user('admin', 'ruid0002', 'cat', 'own')
ha.assert_group("groupguid0001", "admin", "This is a group", "This is a description")
